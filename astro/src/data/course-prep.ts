...
export const IT_GROUPS: ItGroup[] = [
  ...
  { key: 'computer-technician', name: 'Computer Technician', exam: 'CompTIA A+', blurb: 'Hardware, operating systems and support, in preparation for CompTIA A+ (Core 1 & Core 2).' },
  { key: 'networking-technician', name: 'Networking Technician', exam: 'Network+ · Server+ · Linux+ · Cloud+', blurb: 'Networking, servers, Linux and cloud administration, in preparation across four CompTIA exams.' },
  { key: 'cybersecurity', name: 'Cybersecurity', exam: 'Security+ · PenTest+ · CySA+', blurb: 'Security, penetration testing and security operations, in preparation across three CompTIA exams.' },
];
...
export const IT_COURSES: ItCourse[] = [
  ...
  { code: 'ITP 2300', slug: 'itp-2300-server-administration', title: 'Server Administration Fundamentals', exam: 'CompTIA Server+ (SK0-005)', weeks: 6, credits: 4, group: 'networking-technician', description: 'Install, configure, secure and troubleshoot servers in physical and virtual environments, in preparation for CompTIA Server+.' },
  ...
  { code: 'ITP 2600', slug: 'itp-2600-cloud-infrastructure', title: 'Cloud Infrastructure Administration', exam: 'CompTIA Cloud+ (CV0-004)', weeks: 6, credits: 6, group: 'networking-technician', description: 'Cloud architecture, deployment, operations, security and DevOps fundamentals on vendor-neutral labs, in preparation for CompTIA Cloud+.' },
